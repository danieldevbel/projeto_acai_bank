...
class _TransferScreenState extends State<TransferScreen> {
  ...
  void _selectPixKeyType(String type) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => _buildInsertValueAndPixScreen(
            context.watch<BalanceModel>().balance),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 18, color: Color.fromARGB(255, 70, 11, 70)),
            ),
            SizedBox(height: 20),
            ...
            if (_selectedPixKeyType != null) ...[
              Container(
                decoration: BoxDecoration(
                  borderRadius:
                      BorderRadius.circular(10), // Aumenta o raio da borda
                  border: Border.all(
                      color: Color.fromARGB(255, 70, 11, 70),
                      width: 2), // Aumenta a largura da borda
                ),
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    contentPadding: EdgeInsets.symmetric(
                        horizontal: 16,
                        vertical: 12), // Aumenta o padding do conteúdo
                  ),
                  keyboardType: _selectedPixKeyType == 'CPF' ||
                          _selectedPixKeyType == 'Número de Telefone'
          ...
          onPressed: () {
            ...
            if (amount == null || amount <= 0) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                    content: Text(
                        'Por favor, insira um valor válido para a transferência.')),
              );
              return;
            }
            ...
            if (_selectedPixKeyType == 'Número de Telefone' &&
                pixKey.length != 11) {
              ScaffoldMessenger.of(context).showSnackBar(
                                ...
                                TextButton(
                                  onPressed: () {
                                    ...
                                    _shareTransferDetails(
                                        'Transferi R\$${amount.toStringAsFixed(2)} com sucesso.');
                                  },
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        height: 20), // Aumenta o espaçamento entre os itens
                    Row(
                          ...
                          children: [
                            ChoiceChip(
                              ...
                              labelStyle: TextStyle(
                                  fontSize:
                                      18), // Aumenta o tamanho da fonte do label
                          ...
                          children: [
                            ...
                            ChoiceChip(
                              label: Text('Chave Aleatória',
                                  style: TextStyle(color: Colors.white)),
                              selected:
                                  _selectedPixKeyType == 'Chave Aleatória',
                              onSelected: (selected) {
